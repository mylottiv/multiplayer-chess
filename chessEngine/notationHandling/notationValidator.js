...
function notationValidator(rawNotation, playerColor) {
    ...
    // console.log('thirdTest', (!(Object.keys(startingPieceEnum).includes(rawNotation[0]) || fileCharSet.includes(rawNotation[0]) || rankCharSet.includes(rawNotation[0]))));
    ...
    // console.log('fourthTest', (!(fileCharSet.includes(rawNotation[1]) || rankCharSet.includes(rawNotation[1]) || rawNotation[1].toLocaleLowerCase() === 'x')))
    ...
    // console.log('fifthTest', (rawNotation.length > 2 && !(fileCharSet.includes(rawNotation[2]) || rankCharSet.includes(rawNotation[2]) || rawNotation[0].toLocaleLowerCase() === 'x')))
    if (rawNotation.length > 2 && !(fileCharSet.includes(rawNotation[2]) || rankCharSet.includes(rawNotation[2]) || rawNotation[0].toLocaleLowerCase() === 'x')) return 'Invalid Notation';
